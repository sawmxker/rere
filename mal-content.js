(function () {
    ...
    function createModal(title, year, posterUrl) {
        ...
        h3.style.cssText = `margin:0;color:${textColor};font-size:20px;font-weight:700;`;
        h3.textContent = 'Quick rer\u00e9:Search';
        headerTop.appendChild(h3);

        const profileSelect = document.createElement('select');
        profileSelect.style.cssText = `font-size:12px;padding:2px 6px;border-radius:3px;border:1px solid ${borderColor};background:${bgColor};color:${textColor};cursor:pointer;max-width:150px;outline:none;`;
